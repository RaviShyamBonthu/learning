...
public class DeleteDealsPage {
    ...
    public DeleteDealsPage(WebDriver driver) {
        PageFactory.initElements(driver, this);
    }

    public void navigateDealsPage() throws InterruptedException {
    ...
    public void enterFieldsDeals(HashMap<String, String> objMapDealsFields) {
        if (objMapDealsFields.containsKey("Title")) {
            titleField.sendKeys(objMapDealsFields.get("Title"));
        }
        String dropDownTxt = "";
        if (objMapDealsFields.containsKey("DropDown")) {
            dropDownTxt = objMapDealsFields.get("DropDown");
        }
        if (objMapDealsFields.containsKey("selectItem")) {
            selectItemFromDropdown(dropDownTxt, objMapDealsFields.get("selectItem"));
        }
    }
    ...
    WebElement dealsCreatedHeader;

    public void dealsCreated() {
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
    ...
    public void verifyCasesListNotDisplay(String selectVal) throws InterruptedException {
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
